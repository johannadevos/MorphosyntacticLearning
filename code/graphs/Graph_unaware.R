...
colYesUnawareCrit   <- "gray13" # Linienfarbe
...
# Critical items
points(x + diffYesUnawareCrit, meanYesUnawareCrit, col = colYesUnawareCrit, pch = 19, bg = "gray13") # pch 19: Kreis; bg "gray49": fuelle das Symbol mit Farbe.
points(x + diffNoUnawareCrit, meanNoUnawareCrit, col = colNoUnawareCrit, pch = 19, bg = "gray13")

# Control items
points(x + diffYesUnawareContr, meanYesUnawareContr, col = colYesUnawareContr, pch = 22, bg = "gray49") # pch 22: Quadrat
points(x + diffNoUnawareContr, meanNoUnawareContr, col = colNoUnawareContr, pch = 22, bg = "gray49")
...
legend("left",
       ...
       pch = c(19,19,22,22),
       pt.bg = c("gray13", "gray13", "gray49", "gray49"),
       lty = c(1, 3, 1, 3),
       inset = 0.02)
par(cex = 1) #  Fuer weitere Schritte Schriftgroesse wieder auf 100% setzen
...
png("../plots/plot_unaware.png", width=plotwidth, height=plotheight,units="in",res=300)
