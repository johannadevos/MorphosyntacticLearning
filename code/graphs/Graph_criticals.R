...
points(x + diffYesImp, meanYesImp, col = colYesImp, pch = 24, bg = "gray49") # pch 24: Dreieck; bg "gray49": fuelle das Symbol mit Farbe.
points(x + diffNoImp, meanNoImp, col = colNoImp, pch = 24, bg = "gray49")
points(x + diffYesExp, meanYesExp, col = colYesExp, pch = 19, bg = "gray13") # pch 19: Kreis
points(x + diffNoExp, meanNoExp, col = colNoExp, pch = 19, bg = "gray13")
...
legend("bottomright", title = ("Conditions"),
       ...
       pt.bg = c("gray49", "gray49", "gray13", "gray13"), lty = c(1, 3, 1, 3),
       inset = 0.02)
par(cex = 1) #  Fuer weitere Schritte Schriftgroesse wieder auf 100% setzen
