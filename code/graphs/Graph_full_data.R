...
colYesImpCrit   <- "gray39" # Linienfarbe
...
# Critical items
points(x + diffYesImpCrit, meanYesImpCrit, col = colYesImpCrit, pch = 24, bg = "gray39") # pch 24: Dreieck; bg "gray49": fuelle das Symbol mit Farbe.
points(x + diffNoImpCrit, meanNoImpCrit, col = colNoImpCrit, pch = 24, bg = "gray39")
points(x + diffYesExpCrit, meanYesExpCrit, col = colYesExpCrit, pch = 19, bg = "gray11") # pch 19: Kreis
points(x + diffNoExpCrit, meanNoExpCrit, col = colNoExpCrit, pch = 19, bg = "gray11")

# Control items
points(x + diffYesImpContr, meanYesImpContr, col = colYesImpContr, pch = 22, bg = "gray63") # pch 25: Dreieck (Spitze nach unten)
points(x + diffNoImpContr, meanNoImpContr, col = colNoImpContr, pch = 22, bg = "gray63")
points(x + diffYesExpContr, meanYesExpContr, col = colYesExpContr, pch = 23, bg = "gray48") # pch 22: Quadrat
points(x + diffNoExpContr, meanNoExpContr, col = colNoExpContr, pch = 23, bg = "gray48")
...
legend("bottomright",
       ...
       pt.bg = c("gray39", "gray39", "gray11","gray11", "gray63", "gray63", "gray48", "gray48"),
