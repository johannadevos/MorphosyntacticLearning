...
data <- data[data$testmoment!="T3",] # Remove all T3 observations
...
plotwidth = 8
plotheight = 6.5
ggsave("../plots/plot_mainexp_maingroups.png", width=plotwidth, height=plotheight, units="in", dpi = 320) # Save graph
...
plotwidth = 8
plotheight = 6.5
ggsave("../plots/plot_mainexp_unaware.png", width=plotwidth, height=plotheight, units="in", dpi = 320) # Save graph
